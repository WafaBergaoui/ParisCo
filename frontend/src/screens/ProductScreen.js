        ...
        <div>
          ...
          <div>
            ...
            {product.reviews.length === 0 && (
              <MessageBox>Pas de review</MessageBox>
            )}
            <ul>
              ...
              <li>
                {userInfo ? (
                  <form className="form" onSubmit={submitHandler}>
                    <div>
                      <h2>Ecrire un avis client</h2>
                    </div>
                    <div>
                      <label htmlFor="rating">Evaluation</label>
                      <select
                        id="rating"
                        value={rating}
                  ...
                  <MessageBox>
                    S'il te plaît<Link to="/signin">se connecter</Link> pour créer un review
                  </MessageBox>
                )}
              </li>
            </ul>
